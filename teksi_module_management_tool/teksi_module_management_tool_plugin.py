...
class TMMTPlugin(OqtopusPlugin):
    ...
    def __init__(self, iface):
        ...
        if (
            settings.value(f"plugins/{TMMTPluginUtils.PLUGIN_ID}/github-token") is None
            and settings.value("plugins/oqtopus/github-token") is not None
        ):
            settings.setValue(
                f"plugins/{TMMTPluginUtils.PLUGIN_ID}/github-token",
                settings.value("plugins/oqtopus/github-token"),
            )
