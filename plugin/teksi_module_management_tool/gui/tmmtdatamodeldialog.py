...
AVAILABLE_RELEASES = {
    ...
    "2024.0.0": f"https://github.com/teksi/wastewater/archive/2024.0.0.zip",
    "2024.0.1": f"https://github.com/teksi/wastewater/archive/2024.0.1.zip",
}
# if QSettings().value("/tmmt/DeveloperMode", False, type=bool):
#     AVAILABLE_RELEASES.update(
#         {
#             "master": "https://github.com/teksi/datamodel/archive/master.zip",
#         }
#     )

# Allows to pick which QGIS project matches the version (will take the biggest <= match)
DATAMODEL_TWW_VERSIONS = {
    "2024.0.0": "https://github.com/teksi/wastewater/releases/download/v2024.0.0/2024.0.0.zip",
    "2024.0.1": "https://github.com/teksi/wastewater/releases/download/v2024.0.0/2024.0.1.zip",
}
TEMP_DIR = os.path.join(tempfile.gettempdir(), "TWW", "datamodel-init")
...
INIT_SCRIPT_URL_TEMPLATE = "https://github.com/teksi/wastewater/releases/download/{}/qgep_{}_structure_with_value_lists.sql"
TWW_PROJECT_PATH_TEMPLATE = os.path.join(TEMP_DIR, "project", "qgep.qgs")


def tmmt_datamodel_error_catcher(func):
    """Display TMMTDatamodelError in error messages rather than normal exception dialog"""

    @functools.wraps(func)
    def wrapper(*args, **kwargs):
        try:
            return func(*args, **kwargs)
        except TMMTDatamodelError as e:
